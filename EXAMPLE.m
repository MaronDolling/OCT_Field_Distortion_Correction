...
%% Input data
phantom_img = phantom_img1; % this is your spherical phantom image
...
FOV_diameter = 8; % diameter of FOV (circular)
...
options = optimset('Display', 'iter', 'TolFun',...
    1e-5, 'TolX', 1e-05, 'PlotFcns', @optimplotfval, 'MaxIter', 10);
...
SURFACE_corrected = Apply_Coefficients_To_Surface(SURFACE, coefficients, FOV_diameter/2);
